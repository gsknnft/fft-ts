...
export function FFT(input: any): ComplexArray {
  return ensureComplexArray(input).FFT();
}

export function InvFFT(input: any): ComplexArray {
  return ensureComplexArray(input).InvFFT();
}

export function frequencyMap(input: any, filterer: any): ComplexArray {
...
export class ComplexArray extends baseComplexArray {
  ...
  frequencyMap(filterer: any): ComplexArray {
