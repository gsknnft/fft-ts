// import { ComplexArray } from "../types/fft.types";
...
//   /* 
// Element implicitly has an 'any' type because expression of type 'number' can't be used to index type 'HandleArray'.
//   No index signature with a parameter of type 'number' was found on type 'HandleArray'.ts(7053)
